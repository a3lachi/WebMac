    ...
    (function(t, e) {
      ...
      return function() {
        var e = { 365: function(t2, e2, i2) {
          ...
          t2.exports = function(t3) {
            ...
            return e2.toString = function() {
              return this.map(function(e3) {
                var i2 = "", s2 = "undefined" !== typeof e3[5];
                return e3[4] && (i2 += "@supports (".concat(e3[4], ") {")), e3[2] && (i2 += "@media ".concat(e3[2], " {")), s2 && (i2 += "@layer".concat(e3[5].length > 0 ? " ".concat(e3[5]) : "", " {")), i2 += t3(e3), s2 && (i2 += "}"), e3[2] && (i2 += "}"), e3[4] && (i2 += "}"), i2;
              }).join("");
            }, e2.i = function(t4, i2, s2, n2, r) {
              ...
              for (var l = 0; l < t4.length; l++) {
                var c = [].concat(t4[l]);
                s2 && h[c[0]] || ("undefined" !== typeof r && ("undefined" === typeof c[5] || (c[1] = "@layer".concat(c[5].length > 0 ? " ".concat(c[5]) : "", " {").concat(c[1], "}")), c[5] = r), i2 && (c[2] ? (c[1] = "@media ".concat(c[2], " {").concat(c[1], "}"), c[2] = i2) : c[2] = i2), n2 && (c[4] ? (c[1] = "@supports (".concat(c[4], ") {").concat(c[1], "}"), c[4] = n2) : c[4] = "".concat(n2)), e2.push(c));
              }
            }, e2;
          };
        }, 81: function(t2) {
          ...
          "use strict";
          e2.Z = (t3, e3) => {
            const i2 = t3.__vccOpts || t3;
            for (const [s2, n2] of e3)
              i2[s2] = n2;
            return i2;
          };
        }, 733: function(t2, e2, i2) {
          var s2 = i2(365);
          s2.__esModule && (s2 = s2.default), "string" === typeof s2 && (s2 = [[t2.id, s2, ""]]), s2.locals && (t2.exports = s2.locals);
          var n2 = i2(650).Z;
          n2("833bf5a8", s2, true, { sourceMap: false, shadowMode: false });
        }, 650: function(t2, e2, i2) {
          "use strict";
          function s2(t3, e3) {
            for (var i3 = [], s3 = {}, n3 = 0; n3 < e3.length; n3++) {
              var r2 = e3[n3], h2 = r2[0], a2 = r2[1], o2 = r2[2], l2 = r2[3], c2 = { id: t3 + ":" + n3, css: a2, media: o2, sourceMap: l2 };
              s3[h2] ? s3[h2].parts.push(c2) : i3.push(s3[h2] = { id: h2, parts: [c2] });
            }
            return i3;
          }
          i2.d(e2, { Z: function() {
          ...
          var n2 = "undefined" !== typeof document;
          if ("undefined" !== typeof DEBUG && DEBUG && !n2)
            throw new Error("vue-style-loader cannot be used in a non-browser environment. Use { target: 'node' } in your Webpack config to indicate a server-rendering environment.");
          var r = {}, h = n2 && (document.head || document.getElementsByTagName("head")[0]), a = null, o = 0, l = false, c = function() {
          }, d = null, u = "data-vue-ssr-id", m = "undefined" !== typeof navigator && /msie [6-9]\b/.test(navigator.userAgent.toLowerCase());
          function f(t3, e3, i3, n3) {
            l = i3, d = n3 || {};
            var h2 = s2(t3, e3);
            return p(h2), function(e4) {
              for (var i4 = [], n4 = 0; n4 < h2.length; n4++) {
                var a2 = h2[n4], o2 = r[a2.id];
                o2.refs--, i4.push(o2);
              }
              e4 ? (h2 = s2(t3, e4), p(h2)) : h2 = [];
              for (n4 = 0; n4 < i4.length; n4++) {
                o2 = i4[n4];
                if (0 === o2.refs) {
                  for (var l2 = 0; l2 < o2.parts.length; l2++)
                    o2.parts[l2]();
                  delete r[o2.id];
                }
              }
          ...
          function p(t3) {
            for (var e3 = 0; e3 < t3.length; e3++) {
              var i3 = t3[e3], s3 = r[i3.id];
              if (s3) {
                s3.refs++;
                for (var n3 = 0; n3 < s3.parts.length; n3++)
                  s3.parts[n3](i3.parts[n3]);
                for (; n3 < i3.parts.length; n3++)
                  s3.parts.push(v(i3.parts[n3]));
                s3.parts.length > i3.parts.length && (s3.parts.length = i3.parts.length);
              } else {
                var h2 = [];
                for (n3 = 0; n3 < i3.parts.length; n3++)
                  h2.push(v(i3.parts[n3]));
                r[i3.id] = { id: i3.id, refs: 1, parts: h2 };
              }
            }
          }
          function b() {
            var t3 = document.createElement("style");
            return t3.type = "text/css", h.appendChild(t3), t3;
          }
          function v(t3) {
            var e3, i3, s3 = document.querySelector("style[" + u + '~="' + t3.id + '"]');
            if (s3) {
              if (l)
                return c;
            ...
            if (m) {
              var n3 = o++;
              s3 = a || (a = b()), e3 = z.bind(null, s3, n3, false), i3 = z.bind(null, s3, n3, true);
            } else
              s3 = b(), e3 = w.bind(null, s3), i3 = function() {
                s3.parentNode.removeChild(s3);
              };
            return e3(t3), function(s4) {
              if (s4) {
                if (s4.css === t3.css && s4.media === t3.media && s4.sourceMap === t3.sourceMap)
                  return;
                e3(t3 = s4);
              } else
                i3();
          ...
          var g = function() {
            ...
            return function(e3, i3) {
              return t3[e3] = i3, t3.filter(Boolean).join("\n");
            };
          }();
          function z(t3, e3, i3, s3) {
            var n3 = i3 ? "" : s3.css;
            if (t3.styleSheet)
              t3.styleSheet.cssText = g(e3, n3);
            else {
              var r2 = document.createTextNode(n3), h2 = t3.childNodes;
              h2[e3] && t3.removeChild(h2[e3]), h2.length ? t3.insertBefore(r2, h2[e3]) : t3.appendChild(r2);
            }
          }
          function w(t3, e3) {
            var i3 = e3.css, s3 = e3.media, n3 = e3.sourceMap;
            if (s3 && t3.setAttribute("media", s3), d.ssrId && t3.setAttribute(u, e3.id), n3 && (i3 += "\n/*# sourceURL=" + n3.sources[0] + " */", i3 += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(n3)))) + " */"), t3.styleSheet)
              t3.styleSheet.cssText = i3;
            else {
              while (t3.firstChild)
                t3.removeChild(t3.firstChild);
              t3.appendChild(document.createTextNode(i3));
            }
          }
        }, 203: function(e2) {
          "use strict";
        ...
        function s(t2) {
          ...
          return e[t2](r, r.exports, s), r.exports;
        }
        !function() {
          s.n = function(t2) {
        ...
        return function() {
          "use strict";
          if (s.r(n), s.d(n, { default: function() {
            return m;
          } }), "undefined" !== typeof window) {
            var t2 = window.document.currentScript, e2 = t2 && t2.src.match(/(.+\/)[^/]+\.js(\?.*)?$/);
            e2 && (s.p = e2[1]);
          }
          var i2 = s(203);
          function r(t3, e3, s2, n2, r2, h2) {
            return (0, i2.openBlock)(), (0, i2.createElementBlock)("div", { ref: "parent", class: "resizable-component", style: (0, i2.normalizeStyle)(h2.style) }, [(0, i2.renderSlot)(t3.$slots, "default", {}, void 0, true), ((0, i2.openBlock)(true), (0, i2.createElementBlock)(i2.Fragment, null, (0, i2.renderList)(s2.active, (t4) => (0, i2.withDirectives)(((0, i2.openBlock)(), (0, i2.createElementBlock)("div", { key: t4, class: (0, i2.normalizeClass)("resizable-" + t4) }, null, 2)), [[i2.vShow, !s2.maximize]])), 128))], 4);
          }
          const h = { "resizable-r": { bit: 1, cursor: "e-resize" }, "resizable-rb": { bit: 3, cursor: "se-resize" }, "resizable-b": { bit: 2, cursor: "s-resize" }, "resizable-lb": { bit: 6, cursor: "sw-resize" }, "resizable-l": { bit: 4, cursor: "w-resize" }, "resizable-lt": { bit: 12, cursor: "nw-resize" }, "resizable-t": { bit: 8, cursor: "n-resize" }, "resizable-rt": { bit: 9, cursor: "ne-resize" }, "drag-el": { bit: 15, cursor: "pointer" } }, a = { l: 1, t: 2, w: 4, h: 8 };
          var o = { name: "VResizable", props: { width: { default: void 0, type: [Number, String] }, minWidth: { default: 0, type: Number }, maxWidth: { default: void 0, type: Number }, height: { default: void 0, type: [Number, String] }, minHeight: { default: 0, type: Number }, maxHeight: { default: void 0, type: Number }, left: { default: 0, type: [Number, String] }, top: { default: 0, type: [Number, String] }, active: { default: () => ["r", "rb", "b", "lb", "l", "lt", "t", "rt"], validator: (t3) => ["r", "rb", "b", "lb", "l", "lt", "t", "rt"].filter((e3) => -1 !== t3.indexOf(e3)).length === t3.length, type: Array }, fitParent: { default: false, type: Boolean }, dragSelector: { default: void 0, type: String }, maximize: { default: false, type: Boolean }, disableAttributes: { default: () => [], validator: (t3) => ["l", "t", "w", "h"].filter((e3) => -1 !== t3.indexOf(e3)).length === t3.length, type: Array } }, emits: ["mount", "destroy", "resize:start", "resize:move", "resize:end", "drag:start", "drag:move", "drag:end", "maximize"], data() {
            ...
            return { ...this.calcMap & a.w && { width: "number" === typeof this.w ? this.w + "px" : this.w }, ...this.calcMap & a.h && { height: "number" === typeof this.h ? this.h + "px" : this.h }, ...this.calcMap & a.l && { left: "number" === typeof this.l ? this.l + "px" : this.l }, ...this.calcMap & a.t && { top: "number" === typeof this.t ? this.t + "px" : this.t } };
          } }, watch: { maxWidth(t3) {
            this.maxW = t3;
          }, maxHeight(t3) {
            this.maxH = t3;
          ...
          }, methods: { setMaximize(t3) {
            const e3 = this.$el.parentElement;
            t3 ? (this.prevState = { w: this.w, h: this.h, l: this.l, t: this.t }, this.t = this.l = 0, this.w = e3.clientWidth, this.h = e3.clientHeight) : this.restoreSize();
          }, restoreSize() {
            this.prevState && (this.l = this.prevState.l, this.t = this.prevState.t, this.h = this.prevState.h, this.w = this.prevState.w);
          }, setupDragElements(t3) {
            const e3 = this.$el.querySelectorAll(".drag-el");
            e3.forEach((t4) => {
              t4.classList.remove("drag-el");
            });
            const i3 = this.$el.querySelectorAll(t3);
            i3.forEach((t4) => {
              t4.classList.add("drag-el");
            }), this.dragElements = Array.prototype.slice.call(i3);
          }, emitEvent(t3, e3) {
            this.$emit(t3, { eventName: t3, left: this.l, top: this.t, width: this.w, height: this.h, cmp: this, ...e3 });
          }, handleMove(t3) {
            if (0 !== this.resizeState) {
              let e3, i3;
              if (this.dragState || (isNaN(this.w) && (this.w = this.$el.clientWidth), isNaN(this.h) && (this.h = this.$el.clientHeight)), t3.touches && t3.touches.length >= 0 ? (e3 = t3.touches[0].clientY, i3 = t3.touches[0].clientX) : (e3 = t3.clientY, i3 = t3.clientX), this.maximize && this.prevState) {
                const t4 = this.parent.width, s3 = this.parent.height;
                this.restoreSize(), this.prevState = void 0, this.t = e3 > s3 / 2 ? s3 - this.h : 0, this.l = i3 > t4 / 2 ? t4 - this.w : 0, this.emitEvent("maximize", { state: false });
              }
              let s2 = i3 - this.mouseX + this.offsetX, n2 = e3 - this.mouseY + this.offsetY;
              if (this.$el.getBoundingClientRect) {
                const t4 = this.$el.getBoundingClientRect(), e4 = t4.width / this.$el.offsetWidth || 1, i4 = t4.height / this.$el.offsetHeight || 1;
                s2 /= e4, n2 /= i4;
              }
              this.offsetX = this.offsetY = 0, this.resizeState & h["resizable-r"].bit && (!this.dragState && this.w + s2 < this.minW ? this.offsetX = s2 - (s2 = this.minW - this.w) : !this.dragState && this.maxW && this.w + s2 > this.maxW && (!this.fitParent || this.w + this.l < this.parent.width) ? this.offsetX = s2 - (s2 = this.maxW - this.w) : this.fitParent && this.l + this.w + s2 > this.parent.width && (this.offsetX = s2 - (s2 = this.parent.width - this.l - this.w)), this.calcMap & a.w && (this.w += this.dragState ? 0 : s2)), this.resizeState & h["resizable-b"].bit && (!this.dragState && this.h + n2 < this.minH ? this.offsetY = n2 - (n2 = this.minH - this.h) : !this.dragState && this.maxH && this.h + n2 > this.maxH && (!this.fitParent || this.h + this.t < this.parent.height) ? this.offsetY = n2 - (n2 = this.maxH - this.h) : this.fitParent && this.t + this.h + n2 > this.parent.height && (this.offsetY = n2 - (n2 = this.parent.height - this.t - this.h)), this.calcMap & a.h && (this.h += this.dragState ? 0 : n2)), this.resizeState & h["resizable-l"].bit && (!this.dragState && this.w - s2 < this.minW ? this.offsetX = s2 - (s2 = this.w - this.minW) : !this.dragState && this.maxW && this.w - s2 > this.maxW && this.l >= 0 ? this.offsetX = s2 - (s2 = this.w - this.maxW) : this.fitParent && this.l + s2 < 0 && (this.offsetX = s2 - (s2 = -this.l)), this.calcMap & a.l && (this.l += s2), this.calcMap & a.w && (this.w -= this.dragState ? 0 : s2)), this.resizeState & h["resizable-t"].bit && (!this.dragState && this.h - n2 < this.minH ? this.offsetY = n2 - (n2 = this.h - this.minH) : !this.dragState && this.maxH && this.h - n2 > this.maxH && this.t >= 0 ? this.offsetY = n2 - (n2 = this.h - this.maxH) : this.fitParent && this.t + n2 < 0 && (this.offsetY = n2 - (n2 = -this.t)), this.calcMap & a.t && (this.t += n2), this.calcMap & a.h && (this.h -= this.dragState ? 0 : n2)), this.mouseX = i3, this.mouseY = e3;
              const r2 = this.dragState ? "drag:move" : "resize:move";
              this.emitEvent(r2);
            }
          }, handleDown(t3) {
            if (!t3.target.closest || t3.target.closest(".resizable-component") === this.$refs["parent"]) {
              for (let e3 in h)
                if (this.$el.contains(t3.target) && (t3.target.closest && t3.target.closest(`.${e3}`) || t3.target.classList.contains(e3))) {
                  "drag-el" === e3 && (this.dragState = true), document.body.style.cursor = h[e3].cursor, t3.touches && t3.touches.length >= 1 ? (this.mouseX = t3.touches[0].clientX, this.mouseY = t3.touches[0].clientY) : (t3.preventDefault && t3.preventDefault(), this.mouseX = t3.clientX, this.mouseY = t3.clientY), this.offsetX = this.offsetY = 0, this.resizeState = h[e3].bit, this.parent.height = this.$el.parentElement.clientHeight, this.parent.width = this.$el.parentElement.clientWidth;
                  const i3 = this.dragState ? "drag:start" : "resize:start";
                  this.emitEvent(i3);
                  break;
                }
            }
            ...
            if (0 !== this.resizeState) {
              ...
              const t3 = this.dragState ? "drag:end" : "resize:end";
              this.emitEvent(t3), this.dragState = false;
            }
          } } }, l = (s(733), s(82));
          const c = (0, l.Z)(o, [["render", r], ["__scopeId", "data-v-3de5149f"]]);
          var d = c, u = d, m = u;
        }(), n;
      }();
    });
...
export default require_vue_resizable_umd_min();
//# sourceMappingURL=vue-resizable.js.map
